...
The prediction task involves two classes:

    Class 0: Represents companies that are not bankrupt (majority class).
    Class 1: Represents companies that are bankrupt (minority class).
